    ...
    ngOnInit() {
        this.model = [
            { label: 'Dashboard', icon: 'dashboard', routerLink: ['/'] },
            {
                ...
                items: [
                    { label: 'List', icon: 'list', routerLink: ['/portfolio-list'] },
                    { label: 'New Portfolio', icon: 'playlist_add', routerLink: ['/portfolio-add'] },
                    { label: 'Import Porfolios', icon: 'file_upload', routerLink: ['/portfolio-upload'] }
                ]
            },
            {
                label: 'Deal', icon: 'attach_money',
                items: [
                    { label: 'List', icon: 'list', routerLink: ['/deal-list'] },
                    { label: 'Journal', icon: 'date_range', routerLink: ['/deal-journal'] },
                    { label: 'Do', icon: 'add_shopping_cart', routerLink: ['/deal-do'] },
                    { label: 'Import Deals', icon: 'file_upload', routerLink: ['/deal-upload'] }
                ]
            },
            {
                label: 'Benchmark', icon: 'compare_arrows',
                items: [
                    { label: 'List', icon: 'list', routerLink: ['/benchmark-list'] },
                    { label: 'Import Benchmarks', icon: 'file_upload', routerLink: ['/benchmark-upload'] }
                ]
            },
            {
